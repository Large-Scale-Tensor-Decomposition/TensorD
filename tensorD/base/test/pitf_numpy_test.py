...
if __name__ == '__main__':
    ...
    # data_provider.full_tensor = lambda: tf.constant(np.random.rand(100, 50, 8), dtype=tf.float32)
    ...
    # args = PITF.PITF_Args(rank=5, delt=0.8, tao=12, sample_num=1000, validation_internal=1, verbose=False, steps=1000)
